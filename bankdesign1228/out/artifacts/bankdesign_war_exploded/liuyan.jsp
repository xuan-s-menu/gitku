...
<div class="registercard1-box">
    ...
    <input class="registercard1-box-input" name="name" value="请输入管理员名字">
    <div class="registercard1-box-liuyan"><textarea  name="liuyan" rows="10" cols="30">给管理员留言</textarea></div>
