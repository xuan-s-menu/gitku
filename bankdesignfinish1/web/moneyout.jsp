...
<div class="registercard1-box">
    ...
    <div class="registercard1-box-wenzi">请输入转出的卡的名字:</div>
    <input class="registercard1-box-input" name="id" value="请输入名字">
    <div class="registercard1-box-wenzi">请输入转出的余额:</div>
    <input class="registercard1-box-input" name="money" value="请输入钱数">
    <input type="submit" class="registercard1-box-submit" value="开始转出">
    </form>
</div>
